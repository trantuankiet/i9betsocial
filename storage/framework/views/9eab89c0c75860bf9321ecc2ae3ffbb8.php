...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('email', 'admin@i9betsocial.com')); ?>" id="username" name="email" placeholder="Enter username">
...
<?php echo $__env->make('layouts.master-without-nav', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\i9betsocial\resources\views/auth/login.blade.php ENDPATH**/ ?>